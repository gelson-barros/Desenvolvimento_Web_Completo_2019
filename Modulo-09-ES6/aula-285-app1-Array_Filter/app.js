...
funcionarios.filter(function(f){ return f.salario > 2000 })
funcionarios.filter(function(f){ return f.salario < 2000 }).filter(function(f){return f.status == 'activo'})

//arrow function
funcionarios.filter(f => f.salario < 2000 ).filter(f =>f.status == 'activo')
*/