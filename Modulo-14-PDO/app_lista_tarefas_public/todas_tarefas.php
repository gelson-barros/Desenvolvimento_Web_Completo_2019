...
<head>
	...
	<script>
		function editar(id, tx_tarefa) {

			//criar um form de edição
			let form = document.createElement('form')
			form.action = 'tarefa_controller.php?acao=actualizar'
			form.method = 'post'
			form.className = 'row'
			...
			//criar um butto para envio do form
			...
			//limpar texto da div em questao que vai incluir o form 
			tarefa.innerHTML = ''
